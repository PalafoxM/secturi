...
ini.inicio = (function () {
    ...
    return {
        ...
        estatusReservaInterna: function (id_reserva) {
            $('#id_reserva_estatus').val(id_reserva);
            $('#motivo').val('');
            $('#observaciones').val('');
            $('#validar_no_reserva').val('');
        ...
        eliminarSolicitud: function (id_solicitud) {
            Swal.fire({
                title: '¿Está seguro?',
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: base_url + "index.php/Agregar/eliminarSolicitud",
                        type: "POST",
        ...
        guardarSolicitud: function () {
            var form = document.getElementById('form_solicitud_grc');
            var formData = new FormData(form);

            $.ajax({
                url: base_url + "index.php/Agregar/guardarSolicitud",
                type: "POST",
                data: formData,
                contentType: false,
                processData: false,
                dataType: "json",
                beforeSend: function () {
                    $('#btnGuardarSolicitud').prop('disabled', true).html('<i class="fas fa-spinner fa-spin"></i> Guardando...');
                },
                success: function (response) {
                    if (!response.error) {
                        Swal.fire("Éxito", response.respuesta, "success");
                ...
                complete: function () {
                    $('#btnGuardarSolicitud').prop('disabled', false).html('Guardar Solicitud');
                },
                error: function () {
                    Swal.fire("Error", "Error de conexión con el servidor", "error");
                    $('#btnGuardarSolicitud').prop('disabled', false).html('Guardar Solicitud');
