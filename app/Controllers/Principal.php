                ...
                <div class="container">
                    ...
                    <div class="content">
                        ...
                        <p style="font-size: 16px; line-height: 1.6; margin-bottom: 20px;">
                            En caso de que aún no hayas realizado las <strong>justificaciones de tu personal a cargo correspondientes a la quincena 11/2026</strong>, 
                            la cual comprende el periodo del <strong>01 al 16 de junio de 2026</strong>, 
                            tienes hasta el día <strong>lunes 22 de junio hasta las 16:00 hrs</strong> para realizarlas.
                        </p>
    ...
    public function concluidosAceptados()
    {
        ...
        if($session->get('id_perfil') == 1){
          ...
          //var_dump(  $reserva);
            ...
            if($session->get('id_usuario') == 34 || $this->esUsuarioRevisionInternaReservaPT($session->get('id_usuario'))){
