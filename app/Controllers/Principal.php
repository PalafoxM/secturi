...
class Principal extends BaseController
{
    ...
    public function guardarReserva()
    {
        ...
        if($revisionInterna){
            $dataInsert['id_estatus'] = ($session->get('id_usuario') == 34) ? 1 : 5;
            $dataInsert['promo'] = 1;
                $email->setTo([
                'promocionydifusionsectur@guanajuato.gob.mx',
                 $session->get('correo')
   ...
   //     $email->setTo('dasedetur@guanajuato.gob.mx'); // destinatario principal
    ...
    public function listaReservaPT()
    {
        ...
        if (in_array($session->get('id_perfil'), [1, 2])) {
            ...
            if( in_array($session->get('id_usuario'), [34, 88]) ){
    ...
    public function concluidosAceptados()
    {
        ...
        if($session->get('id_perfil') == 1){
          ...
          //var_dump(  $reserva);
            ...
            if(in_array($session->get('id_usuario'), [34, 88]) || $this->esUsuarioRevisionInternaReservaPT($session->get('id_usuario'))){
