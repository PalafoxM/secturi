                                                            ...
                                                            <ol class="dd-list">
                                                                ...
                                                                <li class="dd-item" data-id="1">
                                                                    <a target="_blank" href="<?= base_url().'assets/documentos/Lineamientos-Inversión 2026.pdf' ?>">
                                                                        <div class="dd-handle">
                                                                         Lineamientos Generales para la Aplicación de Recursos en Materia de Proyectos de Inversión 2026
                                                                        </div>
                                                                    </a>
                                                                </li>
                                                                <li class="dd-item" data-id="1">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="custom-dd dd" id="nestable_list_1">
                                                            ...
                                                            <ol class="dd-list">
                                                                ...
                                                                <a target="_blank" href="<?= base_url()?>assets/documentos/Disposiciones Administrativas SECTURI 2026_v1.pdf">  
                                                                    <li class="dd-item" data-id="2">
                                                                        <div class="dd-handle">
                                                                ...
                                                                <a target="_blank" href="<?= base_url()?>assets/documentos/F-RF-07-2026 SOLICITUD GRC.docm" >  
                                                                    <li class="dd-item" data-id="2">
                                                                        <div class="dd-handle">
                                                                        SOLICITUD GRC
                                                                        </div>
