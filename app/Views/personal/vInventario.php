                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="blog-card">
                                        <img src="<?= base_url(); ?>assets/images/small/img-10.jpg" alt="" class="img-fluid"/>
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <div class="meta-box">
                                                <div class="media">
                                                    <img src="<?= base_url(); ?>assets/images/users/user-4.jpg" alt="" class="thumb-sm rounded-circle mr-2">                                       
                                                    <div class="media-body align-self-center text-truncate">
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="blog-card">
                                        <img src="<?= base_url(); ?>assets/images/small/img-11.jpg" alt="" class="img-fluid"/>
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <div class="meta-box">
                                                <div class="media">
                                                    <img src="<?= base_url(); ?>assets/images/users/user-3.jpg" alt="" class="thumb-sm rounded-circle mr-2">                                       
                                                    <div class="media-body align-self-center text-truncate">
                    ...
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="blog-card">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <div class="meta-box">
                                                <div class="media">
                                                    <img src="<?= base_url(); ?>assets/images/users/user-7.jpg" alt="" class="thumb-sm rounded-circle mr-2">                                       
                                                    <div class="media-body align-self-center text-truncate">
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="blog-card">
                                        <img src="<?= base_url(); ?>assets/images/small/img-13.jpg" alt="" class="img-fluid"/>
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <div class="meta-box">
                                                <div class="media">
                                                    <img src="<?= base_url(); ?>assets/images/users/user-5.png" alt="" class="thumb-sm rounded-circle mr-2">                                       
                                                    <div class="media-body align-self-center text-truncate">
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="blog-card">
                                        <img src="<?= base_url(); ?>assets/images/small/img-14.jpg" alt="" class="img-fluid"/>
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <div class="meta-box">
                                                <div class="media">
                                                    <img src="<?= base_url(); ?>assets/images/users/user-8.jpg" alt="" class="thumb-sm rounded-circle mr-2">                                       
                                                    <div class="media-body align-self-center text-truncate">
                                                        <h6 class="mt-0 mb-1 text-dark">Donald Gardner</h6>
                                                        <ul class="p-0 list-inline mb-0">
                                                            <li class="list-inline-item">26 mars 2020</li>
