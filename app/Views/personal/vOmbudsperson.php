                    ...
                    <div class="page-title-box">
                        <div class="float-right">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Ombudsperson</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Ombudsperson</h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 align-self-center">
                                    <div class="single-pro-detail">
                                        <p class="mb-1">Ombudsperson</p>
                                        <div class="custom-border mb-3"></div>
                                        <h3 class="pro-title">Te presentamos a nuestra figura</h3>
