       ...
       <div  style="position:absolute; top:29.8%; left:22%; width:35%; height:10px; background-color:white; font-size: 7px; ">
        ...
        <div  style="position:absolute; text-align:justify;top:31.5%; left:7.5%; width:85%; height:35px; background-color:white; font-size:13px; ">
            <span class="proxima">Solicito que se realice trámite de pago del comprobante fiscal con <strong><?= (isset($uudi) && !empty($uudi))?$uudi:'S/N'?></strong>,
                 derivado del contrato ó convenio número <strong> <?= $reserva->no_convenio;?></strong> por la cantidad de <strong>$<?= $reserva->total_importe;?></strong>
        ...
        <div  style="position:absolute; top:94.7%; left:21.2%; width:30%; height:10px; background-color:white; font-size: 10px; ">
         ...
         <div  style="position:absolute; top:96.8%; left:21.2%; width:30%; height:10px; background-color:white; font-size: 10px; ">
            <span class="proxima"> DIRECTOR DE COMPETITIVIDAD TURIÍSTICA</span>
        </div>
