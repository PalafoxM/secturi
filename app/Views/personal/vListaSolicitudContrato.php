                                        ...
                                        <?php if (!empty($solicitudes)): ?>
                                            <?php foreach ($solicitudes as $sol): ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php $montoTotalLista = (float) str_replace(['$', ',', ' '], '', (string) ($sol->monto_total ?? 0)); ?>
                                                    <td>$<?= number_format($montoTotalLista, 2, '.', ','); ?></td>
                                                    <td>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <?php endif; ?>
                                                        <?php if (!empty($sol->no_contrato)): ?>
                                                            <button class="btn btn-sm btn-outline-info" title="Ver No. Contrato" onclick='verNoDocumento("No. Contrato", <?= json_encode((string) $sol->no_contrato, JSON_HEX_APOS | JSON_HEX_QUOT) ?>)'>
