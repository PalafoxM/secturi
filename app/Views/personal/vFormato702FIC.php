...
<div id="fecha">
 ...
 <div id="fecha_respuesta">
   <?php if(isset($registro->fecha_gasto_inicio) && !empty($registro->fecha_gasto_fin)): ?>
...
<div id="importe_respuesta">
     <?php if(isset($importePartida) && !empty($importePartida)): ?>
   <span > <?= '$' . number_format($importePartida, 2) .' ('.$numero_texto2.')' ?>  </span>
   <?php endif; ?>
</div>
