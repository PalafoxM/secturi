 <div class="page-wrapper">
                            ...
                            <div class="page-title-box">
                                <div class="float-right">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active">Teckets</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Teckets</h4>
                                    ...
                                    <div class="table-responsive">
                                        <table id="datatable" class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td>#1236</td>
                                                <td><img src="<?= base_url(); ?>assets/images/users/user-10.jpg" alt="" class="thumb-sm rounded-circle mr-2">
                                                    Donald Gardner</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>#3569</td>
                                                <td><img src="<?= base_url(); ?>assets/images/users/user-9.jpg" alt="" class="thumb-sm rounded-circle mr-2">
                                                    Kevin J. Heal</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>#9874</td>
                                                <td><img src="<?= base_url(); ?>assets/images/users/user-8.jpg" alt="" class="thumb-sm rounded-circle mr-2">
                                                    Frank M. Lyons</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>#5412</td>
                                                <td><img src="<?= base_url(); ?>assets/images/users/user-7.jpg" alt="" class="thumb-sm rounded-circle mr-2">
                                                    Robert C. Golding</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>#3258</td>
                                                <td><img src="<?= base_url(); ?>assets/images/users/user-6.jpg" alt="" class="thumb-sm rounded-circle mr-2">
                                                    Hyman M. Cross</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>#6636</td>
                                                <td><img src="<?= base_url(); ?>assets/images/users/user-5.jpg" alt="" class="thumb-sm rounded-circle mr-2">
                                                    Phillip T. Morse</td>
        ...
        <script src="<?= base_url();?>assets/pages/jquery.tickets.init.js"></script>
