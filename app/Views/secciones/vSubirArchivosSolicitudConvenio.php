                    ...
                    <div class="page-title-box">
                        <div class="float-right">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?= base_url('index.php/Principal/ListaSolicitudConvenio') ?>">Listado</a></li>
                            ...
                            <form id="formSubirArchivos" enctype="multipart/form-data">
                                ...
                                <div class="row mt-3">
                                    <div class="col-12 text-right">
                                        <a href="<?= base_url('index.php/Principal/ListaSolicitudConvenio') ?>" class="btn btn-secondary">Cancelar</a>
                                        <a onclick="guardarArchivosSolicitudConvenio();" class="btn btn-primary text-white"><i class="fas fa-save"></i> Guardar Archivos</a>
                                    </div>
                                </div>
                            </form>
...
<script>
    ...
    function guardarArchivosSolicitudConvenio() {
        ...
        $.ajax({
            url: '<?= base_url("index.php/Principal/guardarArchivosSolicitudConvenio") ?>',
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
