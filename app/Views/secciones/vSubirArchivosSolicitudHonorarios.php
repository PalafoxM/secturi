                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="formSubirArchivosHonorarios" enctype="multipart/form-data">
                                ...
                                <div class="row mt-3">
                                    <div class="col-12 text-right">
                                        <a href="<?= base_url('index.php/Principal/listadoHonorarios') ?>" class="btn btn-secondary">Cancelar</a>
                                        <a onclick="guardarArchivosSolicitudHonorarios();" class="btn btn-primary text-white"><i class="fas fa-save"></i> Guardar Archivos</a>
                                    </div>
                                </div>
                            </form>
...
<script>
function guardarArchivosSolicitudHonorarios() {
    var form = $('#formSubirArchivosHonorarios')[0];
    ...
    $.ajax({
        url: '<?= base_url("index.php/Principal/guardarArchivosSolicitudHonorarios") ?>',
        type: 'POST',
        data: formData,
        contentType: false,
        processData: false,
        success: function(response) {
            if (!response.error) {
                Swal.fire({
                    ...
                    window.location.href = '<?= base_url("index.php/Principal/listadoHonorarios") ?>';
                });
            } else {
                Swal.fire({
                    icon: 'error',
