                            ...
                            <form id="formSubirArchivos" enctype="multipart/form-data">
                                ...
                                <div class="row mt-3">
                                    <div class="col-12 text-right">
                                        <a href="<?= base_url('index.php/Principal/ListaSolicitudAdquisiciones') ?>" class="btn btn-secondary">Cancelar</a>
                                        <a onclick="guardarArchivosSolicitudAdquisiciones();" class="btn btn-primary text-white"><i class="fas fa-save"></i> Guardar Archivos</a>
                                    </div>
                                </div>
                            </form>
...
<script>
    ...
    function guardarArchivosSolicitudAdquisiciones() {
        ...
        $.ajax({
            url: '<?= base_url("index.php/Principal/guardarArchivosSolicitudAdquisiciones") ?>',
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
