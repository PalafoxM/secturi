                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Formulario PT Extranjero</h4>
                                        ...
                                        <?php
                                            ...
                                            ?>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-3 mb-3">
                                                        <label for="uuid_<?= $i ?>">No. Fiscal/uuid<span style="color:red;">*</span></label>
                                                        <input type="text" class="form-control" autocomplete="off" id="uuid<?= $i ?>" name="uuid[]" placeholder="3FDEC65B-50BC-4588-8BDC-347F41513A11" >
                                                    </div>
                                                    <div class="col-md-2 mb-3">
                                                        <label for="certificado_<?= $i ?>">No. Certificado<span style="color:red;">*</span></label>
                                                        <input type="text" class="form-control" autocomplete="off" id="certificado_<?= $i ?>" name="certificado[]" placeholder="00001000000714855070" >
                                                    </div>
                                                ...
                                                <div id="<?= $section_id ?>">
                                                    <div class="form-row">
                                                        <div class="col-md-2 mb-3">
                                                            ...
                                                            <?php endif; ?>
                                                            <p class="text-muted mb-3">Factura PDF</p> <?= (isset($factura_pdf) && !empty($factura_pdf))? '<a target="_blank" href='.base_url().$factura_pdf[$i]->ruta_relativa.'><i class="mdi dripicons-preview"></i></a>':'' ?>
                                                            <input id="factura_pdf_input_<?= $i; ?>" type="file" name="factura_pdf_<?= $i; ?>[]"   />   
                                                        </div>
                                                        <div class="col-md-2 mb-3">
                                                            <p class="text-muted mb-3">Emisor</p> <?= (isset($factura) && !empty($factura))? '<a target="_blank" href='.base_url().'index.php/Inicio/VerXML/'.$factura[$i]->id_factura.'><i class="mdi dripicons-preview"></i></a>':'' ?>
                                                            <input id="emisor_rfc<?= $i; ?>" type="input" name="emisor_rfc<?= $i; ?>[]" class="form-control" placeholder="RFC" >
                                                        </div>
                                                        <div class="col-md-2 mb-3">
                                                            <p class="text-muted mb-3">Emisor</p> <?= (isset($factura) && !empty($factura))? '<a target="_blank" href='.base_url().'index.php/Inicio/VerXML/'.$factura[$i]->id_factura.'><i class="mdi dripicons-preview"></i></a>':'' ?>
                                                            <input id="emisor_nombre<?= $i; ?>" type="input" name="emisor_nombre<?= $i; ?>[]" class="form-control" placeholder="Nombre" >
                                                        </div>
                                                        <div class="col-md-2 mb-3">
                                                            <p class="text-muted mb-3">Receptor</p> <?= (isset($factura) && !empty($factura))? '<a target="_blank" href='.base_url().'index.php/Inicio/VerXML/'.$factura[$i]->id_factura.'><i class="mdi dripicons-preview"></i></a>':'' ?>
                                                            <input id="emisor_nombre<?= $i; ?>" type="input" name="emisor_nombre<?= $i; ?>[]" class="form-control" placeholder="RFC" >
                                                        </div>
                                                        <div class="col-md-2 mb-3">
                                                            <p class="text-muted mb-3">Receptor</p> <?= (isset($factura) && !empty($factura))? '<a target="_blank" href='.base_url().'index.php/Inicio/VerXML/'.$factura[$i]->id_factura.'><i class="mdi dripicons-preview"></i></a>':'' ?>
                                                            <input id="emisor_nombre<?= $i; ?>" type="input" name="emisor_nombre<?= $i; ?>[]" class="form-control" placeholder="Nombre" >
