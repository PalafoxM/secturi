                                ...
                                <table id="datatableVehiculo" class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td  class="text-center"><?= $e->xml_monto?></td>
                                            <td  class="text-center"><?= $e->xml_razon_social?></td>
                                            <td  class="text-center"><?= $e->xml_uuid?></td>
                                            <td  class="text-center"><?= date('d/m/Y', strtotime($e->fecha_tramite)) ?></td>
                                            <td  class="text-center"><?= date('d/m/Y', strtotime($e->fec_inicio))?></td>
                                            <td  class="text-center"><?= date('d/m/Y', strtotime($e->fec_fin))?></td>
