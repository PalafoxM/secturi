            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Listado de puestoS</h4>
                    </div>
                    <!--end page-title-box-->
                </div>
                <!--end col-->
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <span>puestoES</span>
                                            <button onclick="ini.inicio.agregarPuesto()"
                                                class="btn btn-gradient-primary px-4 float-right mt-0 mb-3"><i
                                                    class="mdi mdi-plus-circle-outline mr-2"></i>Agregar puesto</button>
                                            <table id="datatableCategorias" class="table" data-toggle="table">
                                                ...
                                                <tbody>
                                                    <?php foreach($cat_puesto as $p): ?>
                                                    <tr>
                                                        <td class="text-center"><?= $p->id_puesto?></td>
                                                        <td class="text-center"><?= $p->dsc_puesto?></td>
                                                        ...
                                                        <td class="text-center">
                                                            <button title="editar"
                                                                onclick="ini.inicio.editarPuesto(<?= $p->id_puesto?>)"
                                                                class="btn btn-gradient-warning px-4"><i
                                                                    class="dripicons-pencil font-21"></i>
                                                            </button>
                                                          
                                                            <button title="eliminar"
                                                                onclick="ini.inicio.eliminarPuesto(<?= $p->id_puesto?>)"
