...
<body>
    ...
    <div class="date">
        Silao de la Victoria, Gto, <?= date('d') ?> de <?= $meses[date('n')] ?> de <?= date('Y') ?>
    </div>
    ...
    <div class="body-text">
        ...
        con folio <strong><?= isset($registro_pt->no_consecutivo) ? $registro_pt->no_consecutivo : '000' ?>/<?= date('Y') ?></strong> 
